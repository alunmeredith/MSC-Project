...
ExaminerDistributions <- fit_distributions(2001, out_lab = "test", degree_distribution_all = orderFrequencies, var = "Examiner")
par(mfrow = c(2,2))
    par(cex = .5)
    par(lwd = 2)
...
```{r}
OtherDistributions <- fit_distributions(2001, out_lab = "test", degree_distribution_all = orderFrequencies, var = "Other")
par(mfrow = c(2,2))
    par(cex = .5)
    par(lwd = 2)
