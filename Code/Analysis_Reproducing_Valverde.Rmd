...
```{r normalised plot, fig.height=5, fig.width=10, message=FALSE}
...
```{r, eval=FALSE}
bs_pl = bootstrap_p(m_pl, no_of_sims=100, threads=4)
...
png("Figures/gg1"); gg1; dev.off()
png("Figures/gg1b"); gg1b; dev.off()
png("Figures/gg1blm"); grid.arrange(gg1b.lm1, gg1b.lm2, ncol=2); dev.off()
png("Figures/gg2a"); gg2a; dev.off()
png("Figures/gg2a2"); gg2a2; dev.off()
png("Figures/gg2a3"); gg2a3; dev.off()
