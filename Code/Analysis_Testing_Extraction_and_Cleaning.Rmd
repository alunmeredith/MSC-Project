 ...
 * Parsing Text is slightly more complete than parsing sgml. 
    * We found using the 2001 data (which has both txt and sgml) that the text parsing has `r nrow(txt2001) - nrow(sgml2001)` more entries `r nrow(sgml2001)` vs. `r nrow(txt2001)`, and that all the entries in sgml are present in txt. 
